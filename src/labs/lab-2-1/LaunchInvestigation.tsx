...
/**
 * The "Start Lab" affordance rendered at the bottom of the Lab 2.1 MDX
 * brief, opening the interactive investigation workspace. Imported
  ...
  return (
    <div className="not-prose mt-10 rounded-xl border border-forensic-primary/30 bg-forensic-primarySoft/40 px-5 py-4 shadow-lab-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[14px] font-semibold leading-snug text-forensic-text">
              When you're ready, launch the investigation workspace.
            </p>
        ...
        <button
          type="button"
          onClick={() => navigate('/labs/lab-2-1/investigate')}
